...
class SASolver(object):
    ...
    def __init__(self, process_num: int=4):
        ...
        self.controller = kw.common.SolverLoopController(max_repeat_step=1)
    ...
    def solve(self, 
        ...
        qubo_model: QuboModel = converter.convert()
        ...
        while time.time() - start_time < timeout:
            ...
            solving_num += 1
            print(f"Solving round {solving_num} finished, {len(results)} solutions explored.")
...
class TACOSA(object):
    ...
    def solve(self,):
        ...
        sa = SASolver(process_num=12)
        slack_bound = max(len(self.mems), max(self.mems))
        self.solutions = sa.solve(
            self.tacol.model,
